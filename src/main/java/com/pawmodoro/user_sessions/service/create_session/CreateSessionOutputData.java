 ...
 */
public final class CreateSessionOutputData {
    ...
    private CreateSessionOutputData(Builder builder) {
        this.id = builder.id;
    ...
    /**
     * Builder for CreateSessionOutputData.
     */
    public static final class Builder {
         ...
         * @return The built output data
         */
        public CreateSessionOutputData build() {
            return new CreateSessionOutputData(this);
        }
    }
}
