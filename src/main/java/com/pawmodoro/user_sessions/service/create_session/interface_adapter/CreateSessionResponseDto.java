 ...
 */
public final class CreateSessionResponseDto {
    ...
    private CreateSessionResponseDto(Builder builder) {
        this.id = builder.id;
    ...
    /**
     * Builder for CreateSessionResponseDto.
     */
    public static final class Builder {
         ...
         * @return This builder
         */
        public Builder sessionType(String val) {
         ...
         * @return The built response DTO
         */
        public CreateSessionResponseDto build() {
            return new CreateSessionResponseDto(this);
        }
    }
}
